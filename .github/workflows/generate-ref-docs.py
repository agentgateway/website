...
Reads version config from .github/workflows/versions.json. Generates only
...
Usage (from workflow):
  DOC_VERSION=2.2.x python3 .github/workflows/generate-ref-docs.py
...
def main() -> None:
    ...
    versions_file = os.path.join(website_dir, ".github", "workflows", "versions.json")
