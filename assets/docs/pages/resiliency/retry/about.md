...
| -- | -- | -- | --- | 
| [Request retries]({{< link-hextra path="/resiliency/retry/retry/" >}}) | Specify the number of times and duration for the gateway to try a connection to an unresponsive backend service. | <ul><li>HTTPRoute</li><li>{{< reuse "agw-docs/snippets/trafficpolicy.md" >}} </li></ul>| <ul><li>HTTPRoute</li><li>HTTPRoute rule</li><li>Gateway listener ({{< reuse "agw-docs/snippets/trafficpolicy.md" >}} only)</li></ul> | 
