...
By default, weighted routes are disabled. Upgrade your {{< reuse "/agw-docs/snippets/kgateway.md" >}} Helm installation to enable the feature.
...
{{< cards >}}
  {{< card link="https://github.com/kgateway-dev/kgateway/blob/main/pkg/kgateway/translator/gateway/testutils/inputs/route-sort-weighted.yaml" title="Weighted route input" >}}
  {{< card link="https://github.com/kgateway-dev/kgateway/blob/main/pkg/kgateway/translator/gateway/testutils/outputs/route-sort-weighted.yaml" title="Weighted route output" >}}
{{< /cards >}}
