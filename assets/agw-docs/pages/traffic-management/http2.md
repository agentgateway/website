...
5. Get the access logs of your gateway proxy. 
   ```sh
   kubectl -n {{< reuse "agw-docs/snippets/namespace.md" >}} logs deployments/http | tail -1 | jq --sort-keys
   ```
