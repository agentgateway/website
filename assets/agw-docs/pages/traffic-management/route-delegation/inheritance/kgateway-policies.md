...
kubectl delete httproute parent1 -n {{< reuse "agw-docs/snippets/namespace.md" >}}
kubectl delete httproute parent2 -n {{< reuse "agw-docs/snippets/namespace.md" >}}
kubectl delete httproute child-team1 -n team1
kubectl delete trafficpolicy parent-policy -n {{< reuse "agw-docs/snippets/namespace.md" >}}
