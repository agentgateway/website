...
2. Update port 8443 on the Gateway to allow connections only if the client certificate includes a specific hash and Subject Alt Name. 
       ...
       tls:
         ...
         certificateRefs:
           - name: https-cert
             kind: Secret
         options:
           agentgateway.dev/verify-subject-alt-names: "example.com"
           agentgateway.dev/verify-certificate-hash: "46:DB:0D:C2:E1:4F:0A:05:8C:4F:05:8D:77:B1:8D:7C:1A:BE:18:4F:AF:81:BF:E2:B1:CD:03:43:7F:D8:65:4B"
       allowedRoutes:
         namespaces:
           from: All
   EOF
   ...
   | Setting | Description | 
   | -- | -- | 
   | `agentgateway.dev/verify-certificate-hash` | A comma-delimited list of the certificate hash (fingerprint) that must be present in the peer certificate that is presented during the TLS handshake.  | 
   | `agentgateway.dev/verify-subject-alt-names` | A comma-delimited list of the Subject Alternative Names that must be present in the peer certificate that is presented during the TLS handshake.  |
       ...
       tls:
         ...
         certificateRefs:
           - name: https-cert
             kind: Secret
         options:
           agentgateway.dev/verify-subject-alt-names: "mtls.com"
           agentgateway.dev/verify-certificate-hash: "46:DB:0D:C2:E1:4F:0A:05:8C:4F:05:8D:77:B1:8D:7C:1A:BE:18:4F:AF:81:BF:E2:B1:CD:03:43:7F:D8:65:4B"
       allowedRoutes:
         namespaces:
           from: All
