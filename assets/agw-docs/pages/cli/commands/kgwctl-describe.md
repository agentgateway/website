...
```yaml
-A, --all-namespaces    If present, list the requested objects across all namespaces. Note that any namespace context that you specified with -n or --namespace is ignored.
