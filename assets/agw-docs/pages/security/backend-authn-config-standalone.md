...
For how agentgateway resolves a policy that is set at more than one level, see [Attachment points]({{< link-hextra path="/documentation/configuration/policies/attachment/" >}}).
