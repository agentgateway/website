...
For more general information about {{< reuse "/agw-docs/snippets/kgateway.md" >}} control plane metrics, see [Control plane metrics]({{< link-hextra path="/documentation/observability/control-plane-metrics/">}}).
...
For guidance on setting up the observability stack, which allows for configurable alerting, see the [OpenTelemetry stack guide]({{< link-hextra path="/documentation/observability/otel-stack/">}}).
