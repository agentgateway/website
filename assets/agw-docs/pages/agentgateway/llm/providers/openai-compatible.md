...
{{< version exclude-if="1.2.x,1.1.x" >}}If the upstream needs mixed API formats or a cluster-local backend target, use [custom providers]({{< link-hextra path="/documentation/llm/providers/custom/" >}}) instead. {{< /version >}}For self-hosted targets that already have guides, prefer the dedicated [Ollama]({{< link-hextra path="/documentation/llm/providers/ollama/" >}}) and [vLLM]({{< link-hextra path="/documentation/llm/providers/vllm/" >}}) pages.
