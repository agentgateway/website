...
2. Set up access to the [Gemini]({{< link-hextra path="/documentation/llm/providers/gemini/" >}}) or [Vertex AI]({{< link-hextra path="/documentation/llm/providers/vertex/" >}}) LLM provider.
...
If you already set up [multiple endpoints]({{< link-hextra path="/documentation/llm/providers/multiple-endpoints/" >}}), add these paths to your existing {{< reuse "agw-docs/snippets/backend.md" >}}.
