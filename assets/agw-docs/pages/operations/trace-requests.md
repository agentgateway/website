...
In another terminal, send the request through your usual client.
...
Back in the watch terminal, the next request that arrives at the proxy is traced and printed.
