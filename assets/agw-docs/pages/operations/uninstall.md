...
> [!NOTE]
> Did you use Argo CD to install {{< reuse "/agw-docs/snippets/kgateway.md" >}}? Skip to the [Argo CD steps](#argocd).{{% upstream %}} For Flux installations, skip to the [Flux steps](#flux).{{% /upstream %}}
