...
You can configure retries by using a Kubernetes Gateway API-native configuration or an {{< reuse "agw-docs/snippets/policy.md" >}} as shown in the following table
