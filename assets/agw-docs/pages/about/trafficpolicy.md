...
If you apply multiple {{< reuse "agw-docs/snippets/trafficpolicies.md" >}} by using different attachment options, policies are merged based on specificity and priority. 
