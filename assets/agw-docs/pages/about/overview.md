...
[Learn about the history of the Gateway API](https://kgateway.dev/blog/introduction-to-kubernetes-gateway-api/), or [watch our in-depth video series]({{< link-hextra path="https://kgateway.dev/resources/videos/">}}).
