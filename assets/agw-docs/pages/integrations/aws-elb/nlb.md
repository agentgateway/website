...
5. Review the NLB in the AWS EC2 dashboard. 
   1. Go to the [AWS EC2 dashboard](https://console.aws.amazon.com/console/homeec2). 
   2. In the left navigation, go to **Load Balancing > Load Balancers**.
   3. Find and open the NLB that was created for you, with a name such as `k8s-{{< reuse "agw-docs/snippets/alb-elb-name.md" >}}-awscloud-<hash>`.
