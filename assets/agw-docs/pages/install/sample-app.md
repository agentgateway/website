...
{{< cards >}}
  {{< card link="/docs/kubernetes/latest/traffic-management" title="Traffic management" subtitle="Add routing capabilities to your httpbin route." >}}
  {{< card link="/docs/kubernetes/latest/resiliency" title="Resiliency" subtitle="Make your routes more resilient to failures and disruptions." >}}
  {{< card link="/docs/kubernetes/latest/security" title="Security" subtitle="Secure routes with external authentication and rate limiting policies." >}}
{{< /cards >}}
