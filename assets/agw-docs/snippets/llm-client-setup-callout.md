> [!TIP]
> If you manage models and virtual API keys in the standalone Admin UI, [Client Setup]({{< link-hextra path="/operations/ui/#client-setup" >}}) can generate the connection settings or snippet for this client. Review the gateway URL, select a model and key, choose the client from the **Integration** dropdown, and copy the recipe. Each recipe uses only the values that its client supports.
>
