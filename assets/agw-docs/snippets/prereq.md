...
2. Follow the [Sample app guide]({{< link-hextra path="/operations/sample-app/" >}}) to create a gateway proxy with an HTTP listener and deploy the httpbin sample app.
