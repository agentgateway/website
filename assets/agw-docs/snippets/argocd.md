...
7. Verify that the control plane is up and running.
   ...
   {{< reuse "agw-docs/snippets/pod-name.md" >}}-helm-6b5bb4db6b-c2pkq   1/1     Running   0          4m4s
   ```

8. Verify that the `{{< reuse "/agw-docs/snippets/agw-gatewayclass.md" >}}` GatewayClass is created. You can optionally take a look at how the gateway class is configured by adding the `-o yaml` option to your command.
