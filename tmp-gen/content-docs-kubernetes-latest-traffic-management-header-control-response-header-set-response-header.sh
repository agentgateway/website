...
# Source: content/docs/kubernetes/latest/traffic-management/header-control/response-header.md:126 paths=set-response-header
kubectl apply -f- <<EOF
apiVersion: gateway.networking.k8s.io/v1
kind: HTTPRoute
metadata:
...
# Hidden source: content/docs/kubernetes/latest/traffic-management/header-control/response-header.md:313 paths=set-response-header
YAMLTest -f - <<'EOF'
