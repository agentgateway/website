...
# Source: content/docs/kubernetes/main/resiliency/backend-health.md:41 paths=backend-health
kubectl apply -f- <<EOF
...
# Hidden source: content/docs/kubernetes/main/resiliency/backend-health.md:116 paths=backend-health
