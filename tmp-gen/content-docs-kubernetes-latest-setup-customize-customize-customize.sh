...
# Source: content/docs/kubernetes/latest/setup/customize/customize.md:92 paths=customize
...
# Source: content/docs/kubernetes/latest/setup/customize/customize.md:108 paths=customize
kubectl apply --server-side -f- <<'EOF'
apiVersion: gateway.networking.k8s.io/v1
kind: Gateway
metadata:
...
# Hidden source: content/docs/kubernetes/latest/setup/customize/customize.md:132 paths=customize
YAMLTest -f - <<'EOF'
...
# Source: content/docs/kubernetes/latest/setup/customize/customize.md:257 paths=customize
kubectl delete Gateway agentgateway-config -n agentgateway-system
kubectl delete AgentgatewayParameters agentgateway-config -n agentgateway-system
