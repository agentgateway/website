...
# Source: content/docs/kubernetes/latest/traffic-management/transformations/path-method.md:43 paths=path-method
kubectl apply -f- <<EOF
...
# Source: content/docs/kubernetes/latest/traffic-management/transformations/path-method.md:183 paths=path-method
