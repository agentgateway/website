...
# Source: content/docs/kubernetes/latest/traffic-management/transformations/validate.md:41 paths=validate-defaults
kubectl apply -f- <<EOF
...
# Hidden source: content/docs/kubernetes/latest/traffic-management/transformations/validate.md:60 paths=validate-defaults
YAMLTest -f - <<'EOF'
...
# Source: content/docs/kubernetes/latest/traffic-management/transformations/validate.md:259 paths=validate-defaults,validate-skip
