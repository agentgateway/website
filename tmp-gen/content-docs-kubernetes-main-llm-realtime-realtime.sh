...
# Source: content/docs/kubernetes/main/llm/realtime.md:40 paths=realtime
kubectl apply -f- <<EOF
apiVersion: agentgateway.dev/v1alpha1
kind: AgentgatewayBackend
metadata:
...
# Hidden source: content/docs/kubernetes/main/llm/realtime.md:64 paths=realtime
YAMLTest -f - <<'EOF'
...
# Source: content/docs/kubernetes/main/llm/realtime.md:89 paths=realtime
kubectl apply -f- <<EOF
apiVersion: agentgateway.dev/v1alpha1
...
# Hidden source: content/docs/kubernetes/main/llm/realtime.md:110 paths=realtime
YAMLTest -f - <<'EOF'
...
# Source: content/docs/kubernetes/main/llm/realtime.md:172 paths=realtime
