...
# Source: content/docs/kubernetes/latest/traffic-management/transformations/tracing.md:35 paths=tracing
kubectl apply -f- <<EOF
...
# Hidden source: content/docs/kubernetes/latest/traffic-management/transformations/tracing.md:58 paths=tracing
YAMLTest -f - <<'EOF'
...
# Source: content/docs/kubernetes/latest/traffic-management/transformations/tracing.md:124 paths=tracing
