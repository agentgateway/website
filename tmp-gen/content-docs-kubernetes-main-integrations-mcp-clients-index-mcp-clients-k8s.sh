...
# Hidden source: content/docs/kubernetes/main/integrations/mcp-clients/_index.md:53 paths=mcp-clients-k8s
...
# Hidden source: content/docs/kubernetes/main/integrations/mcp-clients/_index.md:64 paths=mcp-clients-k8s
YAMLTest -f - <<'EOF'
