...
# Source: content/docs/kubernetes/latest/traffic-management/route-delegation/header-query.md:61 paths=route-delegation-prereq
kubectl create namespace team1
kubectl create namespace team2

# Source: content/docs/kubernetes/latest/traffic-management/route-delegation/header-query.md:67 paths=route-delegation-prereq
...
# Hidden source: content/docs/kubernetes/latest/traffic-management/route-delegation/header-query.md:79 paths=route-delegation-prereq
YAMLTest -f - <<'EOF'
...
# Source: content/docs/kubernetes/latest/traffic-management/route-delegation/header-query.md:137 paths=header-query
kubectl apply -f- <<EOF
apiVersion: gateway.networking.k8s.io/v1
kind: HTTPRoute
metadata:
...
# Source: content/docs/kubernetes/latest/traffic-management/route-delegation/header-query.md:188 paths=header-query
kubectl apply -f- <<EOF
apiVersion: gateway.networking.k8s.io/v1
kind: HTTPRoute
metadata:
...
# Source: content/docs/kubernetes/latest/traffic-management/route-delegation/header-query.md:222 paths=header-query
kubectl apply -f- <<EOF
apiVersion: gateway.networking.k8s.io/v1
kind: HTTPRoute
metadata:
...
# Hidden source: content/docs/kubernetes/latest/traffic-management/route-delegation/header-query.md:241 paths=header-query
YAMLTest -f - <<'EOF'
...
# Hidden source: content/docs/kubernetes/latest/traffic-management/route-delegation/header-query.md:260 paths=header-query
...
# Hidden source: content/docs/kubernetes/latest/traffic-management/route-delegation/header-query.md:287 paths=header-query
YAMLTest -f - <<'EOF'
...
# Hidden source: content/docs/kubernetes/latest/traffic-management/route-delegation/header-query.md:327 paths=header-query
YAMLTest -f - <<'EOF'
...
# Hidden source: content/docs/kubernetes/latest/traffic-management/route-delegation/header-query.md:369 paths=header-query
YAMLTest -f - <<'EOF'
...
# Hidden source: content/docs/kubernetes/latest/traffic-management/route-delegation/header-query.md:410 paths=header-query
YAMLTest -f - <<'EOF'
...
# Source: content/docs/kubernetes/latest/traffic-management/route-delegation/header-query.md:436 paths=header-query
