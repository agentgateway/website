...
# Hidden source: content/docs/kubernetes/main/observability/nacks.md:70 paths=nacks
YAMLTest -f - <<'EOF'
...
# Source: content/docs/kubernetes/main/observability/nacks.md:104 paths=nacks
kubectl get events -n agentgateway-system --field-selector=reason=AgentGatewayNackError

# Source: content/docs/kubernetes/main/observability/nacks.md:118 paths=nacks
kubectl describe gateway agentgateway-proxy -n agentgateway-system

# Source: content/docs/kubernetes/main/observability/nacks.md:133 paths=nacks
kubectl describe deployment agentgateway-proxy -n agentgateway-system
