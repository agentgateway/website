...
# Source: content/docs/kubernetes/latest/traffic-management/transformations/access-logs.md:118 paths=access-logs-filter
kubectl apply -f- <<EOF
...
# Hidden source: content/docs/kubernetes/latest/traffic-management/transformations/access-logs.md:142 paths=access-logs-filter
YAMLTest -f - <<'EOF'
...
# Source: content/docs/kubernetes/latest/traffic-management/transformations/access-logs.md:228 paths=access-logs,access-logs-filter
