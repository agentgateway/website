...
# Source: content/docs/kubernetes/latest/traffic-management/transformations/inject-response-body.md:41 paths=inject-header-into-body
kubectl apply -f- <<EOF
...
# Hidden source: content/docs/kubernetes/latest/traffic-management/transformations/inject-response-body.md:60 paths=inject-header-into-body
YAMLTest -f - <<'EOF'
