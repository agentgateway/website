...
# Source: content/docs/kubernetes/main/resiliency/timeouts/idle.md:42 paths=idle-timeout
kubectl apply -f- <<EOF
...
# Hidden source: content/docs/kubernetes/main/resiliency/timeouts/idle.md:109 paths=idle-timeout
YAMLTest -f - <<'EOF'
