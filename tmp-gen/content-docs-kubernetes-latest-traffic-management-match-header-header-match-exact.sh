...
# Source: content/docs/kubernetes/latest/traffic-management/match/header.md:40 paths=header-match-exact
kubectl apply -f- <<EOF
apiVersion: gateway.networking.k8s.io/v1
kind: HTTPRoute
metadata:
...
# Hidden source: content/docs/kubernetes/latest/traffic-management/match/header.md:228 paths=header-match-exact
YAMLTest -f - <<'EOF'
