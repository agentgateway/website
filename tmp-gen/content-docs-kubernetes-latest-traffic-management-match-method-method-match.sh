...
# Source: content/docs/kubernetes/latest/traffic-management/match/method.md:29 paths=method-match
kubectl apply -f- <<EOF
apiVersion: gateway.networking.k8s.io/v1
kind: HTTPRoute
metadata:
...
# Hidden source: content/docs/kubernetes/latest/traffic-management/match/method.md:123 paths=method-match
YAMLTest -f - <<'EOF'
