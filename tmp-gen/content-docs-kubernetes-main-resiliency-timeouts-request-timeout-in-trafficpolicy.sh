...
# Source: content/docs/kubernetes/main/resiliency/timeouts/request.md:135 paths=timeout-in-trafficpolicy
...
# Source: content/docs/kubernetes/main/resiliency/timeouts/request.md:164 paths=timeout-in-trafficpolicy
kubectl apply -f- <<EOF
