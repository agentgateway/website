...
# Source: content/docs/kubernetes/latest/traffic-management/transformations/rewrite.md:34 paths=rewrite
kubectl apply -f- <<EOF
...
# Hidden source: content/docs/kubernetes/latest/traffic-management/transformations/rewrite.md:55 paths=rewrite
YAMLTest -f - <<'EOF'
...
# Source: content/docs/kubernetes/latest/traffic-management/transformations/rewrite.md:119 paths=rewrite
