...
# Source: content/docs/kubernetes/main/resiliency/retry/retry.md:172 paths=retry-in-agentgateway
kubectl apply -f- <<EOF
apiVersion: gateway.networking.k8s.io/v1
kind: HTTPRoute
metadata:
...
# Source: content/docs/kubernetes/main/resiliency/retry/retry.md:199 paths=retry-in-agentgateway
kubectl apply -f- <<EOF
