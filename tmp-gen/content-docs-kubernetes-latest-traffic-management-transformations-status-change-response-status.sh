...
# Source: content/docs/kubernetes/latest/traffic-management/transformations/status.md:31 paths=change-response-status
kubectl apply -f- <<EOF
...
# Hidden source: content/docs/kubernetes/latest/traffic-management/transformations/status.md:52 paths=change-response-status
YAMLTest -f - <<'EOF'
...
# Source: content/docs/kubernetes/latest/traffic-management/transformations/status.md:160 paths=change-response-status
