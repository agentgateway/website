...
# Source: content/docs/kubernetes/latest/setup/listeners/tls-settings.md:17 paths=tls-settings
kubectl apply -f - <<EOF
...
# Hidden source: content/docs/kubernetes/latest/setup/listeners/tls-settings.md:41 paths=tls-settings
YAMLTest -f - <<'EOF'
