...
# Source: content/docs/kubernetes/latest/traffic-management/match/host.md:28 paths=host-match
kubectl apply -f- <<EOF
apiVersion: gateway.networking.k8s.io/v1
kind: HTTPRoute
metadata:
...
# Hidden source: content/docs/kubernetes/latest/traffic-management/match/host.md:103 paths=host-match
YAMLTest -f - <<'EOF'
