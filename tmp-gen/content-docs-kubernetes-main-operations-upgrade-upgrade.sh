...
# Source: content/docs/kubernetes/main/operations/upgrade.md:23 paths=upgrade
export NEW_VERSION=0.0.0-latest-dev

# Source: content/docs/kubernetes/main/operations/upgrade.md:35 paths=upgrade
helm upgrade -i --namespace agentgateway-system --version $NEW_VERSION agentgateway-crds oci://cr.agentgateway.dev/charts/agentgateway-crds

# Hidden source: content/docs/kubernetes/main/operations/upgrade.md:39 paths=upgrade
helm get values agentgateway -n agentgateway-system -o yaml > values.yaml

# Source: content/docs/kubernetes/main/operations/upgrade.md:73 paths=upgrade
helm upgrade -i -n agentgateway-system agentgateway oci://cr.agentgateway.dev/charts/agentgateway \
  -f values.yaml \
  --version $NEW_VERSION

# Hidden source: content/docs/kubernetes/main/operations/upgrade.md:79 paths=upgrade
YAMLTest -f - <<'EOF'
...
# Source: content/docs/kubernetes/main/operations/upgrade.md:102 paths=upgrade
kubectl -n agentgateway-system get pod -l app.kubernetes.io/name=agentgateway -o jsonpath='{.items[0].spec.containers[0].image}'

# Source: content/docs/kubernetes/main/operations/upgrade.md:113 paths=upgrade
