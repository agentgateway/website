...
# Source: content/docs/kubernetes/latest/traffic-management/extproc.md:69 paths=extproc
...
# Hidden source: content/docs/kubernetes/latest/traffic-management/extproc.md:123 paths=extproc
YAMLTest -f - <<'EOF'
...
# Source: content/docs/kubernetes/latest/traffic-management/extproc.md:155 paths=extproc
kubectl apply -f- <<EOF
...
# Hidden source: content/docs/kubernetes/latest/traffic-management/extproc.md:176 paths=extproc
YAMLTest -f - <<'EOF'
