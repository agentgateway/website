...
# Source: content/docs/kubernetes/main/resiliency/keepalive.md:180 paths=http-keepalive
kubectl apply -f- <<EOF
...
# Hidden source: content/docs/kubernetes/main/resiliency/keepalive.md:255 paths=http-keepalive
YAMLTest -f - <<'EOF'
...
# Source: content/docs/kubernetes/main/resiliency/keepalive.md:305 paths=http-keepalive
