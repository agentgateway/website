...
# Source: content/docs/kubernetes/latest/traffic-management/transformations/encode.md:41 paths=encode
kubectl apply -f- <<EOF
...
# Hidden source: content/docs/kubernetes/latest/traffic-management/transformations/encode.md:62 paths=encode
YAMLTest -f - <<'EOF'
