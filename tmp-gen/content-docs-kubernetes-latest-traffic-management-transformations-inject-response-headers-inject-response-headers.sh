...
# Source: content/docs/kubernetes/latest/traffic-management/transformations/inject-response-headers.md:69 paths=inject-response-headers
kubectl apply -f- <<EOF
...
# Hidden source: content/docs/kubernetes/latest/traffic-management/transformations/inject-response-headers.md:97 paths=inject-response-headers
YAMLTest -f - <<'EOF'
...
# Source: content/docs/kubernetes/latest/traffic-management/transformations/inject-response-headers.md:169 paths=inject-response-headers
