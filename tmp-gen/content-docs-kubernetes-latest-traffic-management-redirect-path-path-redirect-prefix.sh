...
# Source: content/docs/kubernetes/latest/traffic-management/redirect/path.md:45 paths=path-redirect-prefix
kubectl apply -f- <<EOF
apiVersion: gateway.networking.k8s.io/v1
kind: HTTPRoute
metadata:
...
# Hidden source: content/docs/kubernetes/latest/traffic-management/redirect/path.md:137 paths=path-redirect-prefix
YAMLTest -f - <<'EOF'
