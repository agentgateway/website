...
# Hidden source: content/docs/kubernetes/latest/traffic-management/transformations/llm-model-headers.md:250 paths=llm-model-headers
kubectl apply -f- <<EOF
apiVersion: gateway.networking.k8s.io/v1
kind: HTTPRoute
metadata:
...
# Hidden source: content/docs/kubernetes/latest/traffic-management/transformations/llm-model-headers.md:270 paths=llm-model-headers
YAMLTest -f - <<'EOF'
...
# Source: content/docs/kubernetes/latest/traffic-management/transformations/llm-model-headers.md:291 paths=llm-model-headers
kubectl apply -f- <<EOF
apiVersion: agentgateway.dev/v1alpha1
...
# Hidden source: content/docs/kubernetes/latest/traffic-management/transformations/llm-model-headers.md:316 paths=llm-model-headers
YAMLTest -f - <<'EOF'
...
# Hidden source: content/docs/kubernetes/latest/traffic-management/transformations/llm-model-headers.md:354 paths=llm-model-headers
