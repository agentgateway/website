...
# Source: content/docs/kubernetes/latest/traffic-management/match/header.md:135 paths=header-match-regex
kubectl apply -f- <<EOF
apiVersion: gateway.networking.k8s.io/v1
kind: HTTPRoute
metadata:
...
# Hidden source: content/docs/kubernetes/latest/traffic-management/match/header.md:256 paths=header-match-regex
YAMLTest -f - <<'EOF'
