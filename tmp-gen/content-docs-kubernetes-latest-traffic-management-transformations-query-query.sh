...
# Source: content/docs/kubernetes/latest/traffic-management/transformations/query.md:32 paths=query
kubectl apply -f- <<EOF
...
# Hidden source: content/docs/kubernetes/latest/traffic-management/transformations/query.md:53 paths=query
YAMLTest -f - <<'EOF'
...
# Source: content/docs/kubernetes/latest/traffic-management/transformations/query.md:182 paths=query
