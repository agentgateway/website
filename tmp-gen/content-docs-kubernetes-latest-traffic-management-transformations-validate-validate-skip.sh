...
# Source: content/docs/kubernetes/latest/traffic-management/transformations/validate.md:136 paths=validate-skip
kubectl apply -f- <<EOF
...
# Hidden source: content/docs/kubernetes/latest/traffic-management/transformations/validate.md:157 paths=validate-skip
YAMLTest -f - <<'EOF'
