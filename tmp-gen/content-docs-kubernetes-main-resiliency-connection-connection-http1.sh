...
# Source: content/docs/kubernetes/main/resiliency/connection.md:71 paths=connection-http1
kubectl apply -f- <<EOF
...
# Hidden source: content/docs/kubernetes/main/resiliency/connection.md:139 paths=connection-http1
YAMLTest -f - <<'EOF'
