...
# Source: content/docs/kubernetes/latest/traffic-management/transformations/encode.md:133 paths=decode
kubectl apply -f- <<EOF
...
# Hidden source: content/docs/kubernetes/latest/traffic-management/transformations/encode.md:154 paths=decode
YAMLTest -f - <<'EOF'
...
# Source: content/docs/kubernetes/latest/traffic-management/transformations/encode.md:213 paths=encode,decode
