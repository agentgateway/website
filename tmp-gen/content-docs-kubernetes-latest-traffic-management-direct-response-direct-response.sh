...
# Source: content/docs/kubernetes/latest/traffic-management/direct-response.md:46 paths=direct-response
kubectl apply -f- <<EOF
apiVersion: gateway.networking.k8s.io/v1
kind: HTTPRoute
metadata:
...
# Source: content/docs/kubernetes/latest/traffic-management/direct-response.md:66 paths=direct-response
kubectl apply -f- <<EOF
...
# Hidden source: content/docs/kubernetes/latest/traffic-management/direct-response.md:86 paths=direct-response
YAMLTest -f - <<'EOF'
...
# Hidden source: content/docs/kubernetes/latest/traffic-management/direct-response.md:105 paths=direct-response
YAMLTest -f - <<'EOF'
