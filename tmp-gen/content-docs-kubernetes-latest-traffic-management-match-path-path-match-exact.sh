...
# Source: content/docs/kubernetes/latest/traffic-management/match/path.md:47 paths=path-match-exact
kubectl apply -f- <<EOF
apiVersion: gateway.networking.k8s.io/v1
kind: HTTPRoute
metadata:
...
# Hidden source: content/docs/kubernetes/latest/traffic-management/match/path.md:122 paths=path-match-exact
