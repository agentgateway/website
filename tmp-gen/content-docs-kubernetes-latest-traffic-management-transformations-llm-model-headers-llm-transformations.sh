...
# Hidden source: content/docs/kubernetes/latest/traffic-management/transformations/llm-model-headers.md:42 paths=llm-transformations
kubectl apply -f- <<EOF
apiVersion: gateway.networking.k8s.io/v1
kind: HTTPRoute
metadata:
...
# Hidden source: content/docs/kubernetes/latest/traffic-management/transformations/llm-model-headers.md:62 paths=llm-transformations
YAMLTest -f - <<'EOF'
...
# Source: content/docs/kubernetes/latest/traffic-management/transformations/llm-model-headers.md:83 paths=llm-transformations
kubectl apply -f- <<EOF
apiVersion: agentgateway.dev/v1alpha1
...
# Hidden source: content/docs/kubernetes/latest/traffic-management/transformations/llm-model-headers.md:105 paths=llm-transformations
YAMLTest -f - <<'EOF'
...
# Hidden source: content/docs/kubernetes/latest/traffic-management/transformations/llm-model-headers.md:186 paths=llm-transformations
YAMLTest -f - <<'EOF'
...
# Source: content/docs/kubernetes/latest/traffic-management/transformations/llm-model-headers.md:460 paths=llm-transformations,llm-model-headers
...
# Hidden source: content/docs/kubernetes/latest/traffic-management/transformations/llm-model-headers.md:465 paths=llm-transformations,llm-model-headers
