...
# Source: content/docs/kubernetes/main/resiliency/connection.md:176 paths=connection-http2-flow
kubectl apply -f- <<EOF
...
# Hidden source: content/docs/kubernetes/main/resiliency/connection.md:248 paths=connection-http2-flow
YAMLTest -f - <<'EOF'
