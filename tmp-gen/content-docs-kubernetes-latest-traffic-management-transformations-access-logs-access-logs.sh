...
# Source: content/docs/kubernetes/latest/traffic-management/transformations/access-logs.md:39 paths=access-logs
kubectl apply -f- <<EOF
...
# Hidden source: content/docs/kubernetes/latest/traffic-management/transformations/access-logs.md:64 paths=access-logs
YAMLTest -f - <<'EOF'
