...
# Source: content/docs/kubernetes/main/resiliency/keepalive.md:45 paths=tcp-keepalive
kubectl apply -f- <<EOF
...
# Hidden source: content/docs/kubernetes/main/resiliency/keepalive.md:119 paths=tcp-keepalive
YAMLTest -f - <<'EOF'
...
# Source: content/docs/kubernetes/main/resiliency/keepalive.md:169 paths=tcp-keepalive
