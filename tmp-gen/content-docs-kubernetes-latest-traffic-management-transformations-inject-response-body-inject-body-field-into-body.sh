...
# Source: content/docs/kubernetes/latest/traffic-management/transformations/inject-response-body.md:120 paths=inject-body-field-into-body
kubectl apply -f- <<EOF
...
# Hidden source: content/docs/kubernetes/latest/traffic-management/transformations/inject-response-body.md:139 paths=inject-body-field-into-body
YAMLTest -f - <<'EOF'
...
# Source: content/docs/kubernetes/latest/traffic-management/transformations/inject-response-body.md:197 paths=inject-header-into-body,inject-body-field-into-body
