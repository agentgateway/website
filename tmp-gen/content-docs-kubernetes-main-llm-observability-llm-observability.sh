...
# Hidden source: content/docs/kubernetes/main/llm/observability.md:54 paths=llm-observability
...
# Source: content/docs/kubernetes/main/llm/observability.md:90 paths=llm-observability
kubectl logs deployment/agentgateway-proxy -n agentgateway-system

# Hidden source: content/docs/kubernetes/main/llm/observability.md:103 paths=llm-observability
