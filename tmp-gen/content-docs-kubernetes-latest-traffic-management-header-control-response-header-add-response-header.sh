...
# Source: content/docs/kubernetes/latest/traffic-management/header-control/response-header.md:50 paths=add-response-header
kubectl apply -f- <<EOF
apiVersion: gateway.networking.k8s.io/v1
kind: HTTPRoute
metadata:
...
# Hidden source: content/docs/kubernetes/latest/traffic-management/header-control/response-header.md:297 paths=add-response-header
YAMLTest -f - <<'EOF'
