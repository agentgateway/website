...
# Source: content/docs/kubernetes/main/resiliency/retry/per-try-timeout.md:297 paths=per-try-timeout-in-gatewaylistener
kubectl apply -f- <<EOF
apiVersion: gateway.networking.k8s.io/v1
kind: HTTPRoute
metadata:
...
# Source: content/docs/kubernetes/main/resiliency/retry/per-try-timeout.md:321 paths=per-try-timeout-in-gatewaylistener
kubectl apply -f- <<EOF
...
# Hidden source: content/docs/kubernetes/main/resiliency/retry/per-try-timeout.md:417 paths=per-try-timeout-in-httproute,per-try-timeout-in-agentgateway,per-try-timeout-in-gatewaylistener
YAMLTest -f - <<'EOF'
...
# Hidden source: content/docs/kubernetes/main/resiliency/retry/per-try-timeout.md:502 paths=per-try-timeout-in-gatewaylistener
YAMLTest -f - <<'EOF'
