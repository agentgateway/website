...
# Source: content/docs/kubernetes/latest/traffic-management/transformations/remove-header.md:74 paths=remove-header
kubectl apply -f- <<EOF
...
# Hidden source: content/docs/kubernetes/latest/traffic-management/transformations/remove-header.md:94 paths=remove-header
YAMLTest -f - <<'EOF'
...
# Source: content/docs/kubernetes/latest/traffic-management/transformations/remove-header.md:159 paths=remove-header
