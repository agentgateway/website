...
# Source: content/docs/kubernetes/latest/traffic-management/dfp.md:61 paths=dfp
kubectl apply -f- <<EOF
...
# Source: content/docs/kubernetes/latest/traffic-management/dfp.md:74 paths=dfp
kubectl apply -f- <<EOF
apiVersion: gateway.networking.k8s.io/v1
kind: HTTPRoute
metadata:
...
# Hidden source: content/docs/kubernetes/latest/traffic-management/dfp.md:93 paths=dfp
YAMLTest -f - <<'EOF'
...
# Hidden source: content/docs/kubernetes/latest/traffic-management/dfp.md:112 paths=dfp
YAMLTest -f - <<'EOF'
