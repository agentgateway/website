...
# Source: content/docs/kubernetes/latest/traffic-management/header-control/response-header.md:231 paths=remove-response-header
kubectl apply -f- <<EOF
apiVersion: gateway.networking.k8s.io/v1
kind: HTTPRoute
metadata:
...
# Hidden source: content/docs/kubernetes/latest/traffic-management/header-control/response-header.md:329 paths=remove-response-header
YAMLTest -f - <<'EOF'
