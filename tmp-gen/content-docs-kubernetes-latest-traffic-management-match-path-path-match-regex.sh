...
# Source: content/docs/kubernetes/latest/traffic-management/match/path.md:363 paths=path-match-regex
kubectl apply -f- <<EOF
...
# Hidden source: content/docs/kubernetes/latest/traffic-management/match/path.md:487 paths=path-match-regex
