...
# Source: content/docs/kubernetes/latest/traffic-management/match/path.md:185 paths=path-match-prefix
kubectl apply -f- <<EOF
apiVersion: gateway.networking.k8s.io/v1
kind: HTTPRoute
metadata:
...
# Hidden source: content/docs/kubernetes/latest/traffic-management/match/path.md:283 paths=path-match-prefix
