...
# Source: content/docs/kubernetes/latest/traffic-management/transformations/filter-request-body.md:32 paths=filter-request-body
kubectl apply -f- <<EOF
...
# Hidden source: content/docs/kubernetes/latest/traffic-management/transformations/filter-request-body.md:51 paths=filter-request-body
YAMLTest -f - <<'EOF'
...
# Source: content/docs/kubernetes/latest/traffic-management/transformations/filter-request-body.md:122 paths=filter-request-body
