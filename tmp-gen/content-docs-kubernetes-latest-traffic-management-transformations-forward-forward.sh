...
# Source: content/docs/kubernetes/latest/traffic-management/transformations/forward.md:30 paths=forward
kubectl apply -f- <<EOF
...
# Hidden source: content/docs/kubernetes/latest/traffic-management/transformations/forward.md:51 paths=forward
YAMLTest -f - <<'EOF'
...
# Source: content/docs/kubernetes/latest/traffic-management/transformations/forward.md:119 paths=forward
