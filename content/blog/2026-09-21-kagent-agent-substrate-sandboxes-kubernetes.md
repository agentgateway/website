...
{{< reuse-image src="img/blog/kagent-agent-substrate/sandbox-boundary.jpeg" >}}
...
{{< reuse-image src="img/blog/kagent-agent-substrate/agent-substrate-architecture.png" >}}
...
{{< reuse-image src="img/blog/kagent-agent-substrate/gvisor-microvm-isolation.gif" >}}
...
{{< reuse-image src="img/blog/kagent-agent-substrate/kagent-ui-agent-created.png" >}}

{{< reuse-image src="img/blog/kagent-agent-substrate/kagent-ui-template-created.png" >}}
...
{{< reuse-image src="img/blog/kagent-agent-substrate/kagent-ui-agents-pane.png" width="300px" >}}

2. Click the purple **+ New template** button.

{{< reuse-image src="img/blog/kagent-agent-substrate/kagent-ui-new-template-button.png" >}}

You can then define the template like how you did in the YAML within the previous section.

{{< reuse-image src="img/blog/kagent-agent-substrate/kagent-ui-new-agent-template.png" >}}

3. Go into the Harness configuration via the purple **+ New Harness** section.

{{< reuse-image src="img/blog/kagent-agent-substrate/kagent-ui-new-harness.png" >}}
...
{{< reuse-image src="img/blog/kagent-agent-substrate/kagent-ui-agents-tab-assistant.png" >}}
...
{{< reuse-image src="img/blog/kagent-agent-substrate/kagent-ui-substrate-tab-8-actors.png" >}}

Next, open your Agent and prompt it with whatever you'd like.

{{< reuse-image src="img/blog/kagent-agent-substrate/kagent-ui-agent-session.png" >}}
...
{{< reuse-image src="img/blog/kagent-agent-substrate/kagent-ui-substrate-9-actors.png" >}}
...
1. The Agent Substrate 101 series:
    - [Not all sandboxes are the same](https://www.solo.io/resources/webinar/agent-substrate-101-not-all-sandboxes-are-the-same)
    - [Scaling agents changes the Kubernetes equation](https://www.solo.io/resources/webinar/agent-substrate-101-scaling-agents-changes-the-kubernetes-equation)
    - [Stop paying for agents that aren't doing anything](https://www.solo.io/resources/webinar/agent-substrate-101-stop-paying-for-agents-that-arent-doing-anything)
