...
{{< cards >}}
  {{< card link="/docs/local/" title="Local Binary" subtitle="Run agentgateway as a standalone binary or in Docker on your local machine or server. Perfect for development, testing, and simple deployments." image="/logo-dark-local-binary.svg" >}}
