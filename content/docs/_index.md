...
{{< cards >}}
  ...
  {{< card path="/kubernetes/latest/" title="Kubernetes" subtitle="Deploy agentgateway on Kubernetes by using the kgateway control plane. Ideal for production environments with advanced orchestration needs." image="/logo-kubernetes.svg" >}}
{{< /cards >}}
</div>
