...
To generate a model catalog with `agctl catalog import` and wire it into agentgateway, see [Model costs]({{< link-hextra path="/documentation/llm/cost-controls/costs/" >}}).
