...
> [!NOTE]
> Remove the resources you created in this guide only if you do not plan to continue to [Route across models with virtual models]({{< link-hextra path="/documentation/llm/models/virtual/" >}}).
