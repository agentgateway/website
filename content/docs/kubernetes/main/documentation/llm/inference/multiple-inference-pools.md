...
url: /docs/kubernetes/main/documentation/llm/multiple-inference-pools/
test: skip
---
...
quickstart]({{< link-hextra path="/documentation/llm/inference/inference-routing/#setup" >}}). In the
...
Complete the [inference routing quickstart]({{< link-hextra path="/documentation/llm/inference/inference-routing/#setup" >}}). The quickstart creates:
...
> InferencePools]({{< link-hextra path="/documentation/llm/inference/inference-routing/#ai-policies" >}}).
