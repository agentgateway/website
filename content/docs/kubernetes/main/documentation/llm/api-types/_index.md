...
This section covers the API types that take configuration of their own. For the full list of route types, and to map several endpoints on the same {{< reuse "agw-docs/snippets/backend.md" >}}, see [Multiple endpoints]({{< link-hextra path="/integrations/llm/providers/multiple-endpoints/" >}}).
