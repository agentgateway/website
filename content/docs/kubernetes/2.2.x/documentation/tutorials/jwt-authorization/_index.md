...
{{< cards >}}
  {{< card path="/documentation/security/jwt/" title="JWT Reference" subtitle="Complete JWT configuration options" >}}
  {{< card path="/documentation/mcp/tool-access" title="Tool Access Control" subtitle="Control MCP tool access with JWT claims" >}}
  {{< card path="/documentation/tutorials/ai-prompt-guard" title="AI Prompt Guard" subtitle="Block sensitive data in LLM requests" >}}
{{< /cards >}}
