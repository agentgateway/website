...
{{< cards >}}
  ...
  {{< card path="/documentation/tutorials/ai-prompt-guard" title="AI prompt guard" subtitle="Advanced prompt guard patterns" >}}
  {{< card path="/documentation/tutorials/prompt-enrichment" title="Prompt enrichment" subtitle="Inject context at the gateway layer" >}}
{{< /cards >}}
