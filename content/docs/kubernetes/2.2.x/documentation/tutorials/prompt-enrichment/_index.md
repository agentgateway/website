...
{{< cards >}}
  {{< card path="/documentation/llm/prompt-enrichment" title="Prompt Enrichment Reference" subtitle="Complete configuration options" >}}
  {{< card path="/documentation/tutorials/ai-prompt-guard" title="AI Prompt Guard" subtitle="Block sensitive data in requests" >}}
  {{< card path="/documentation/tutorials/llm-gateway" title="LLM Gateway" subtitle="Route to multiple providers" >}}
{{< /cards >}}
