...
{{< cards >}}
  {{< card path="/documentation/llm/prompt-guards" title="Prompt Guards Reference" subtitle="Complete prompt guard configuration" >}}
  {{< card path="/documentation/tutorials/telemetry" title="Telemetry" subtitle="Add observability to your deployment" >}}
  {{< card path="/documentation/llm" title="LLM Overview" subtitle="All LLM gateway features" >}}
{{< /cards >}}
