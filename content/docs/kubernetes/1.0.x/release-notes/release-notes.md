...
Review the following Helm configuration example. For more information, see [Advanced install settings]({{< link-hextra path="/documentation/install/advanced/" >}}).
...
You can now attach GRPCRoutes to your agentgateway proxy to route traffic to gRPC endpoints. For more information, see [gRPC routing]({{< link-hextra path="/documentation/traffic-management/grpc/" >}}). 
...
For more information, see [Transform requests]({{< link-hextra path="/documentation/llm/transformations/" >}}).
