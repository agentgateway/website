...
> [!NOTE]
> This policy is different from [Buffering]({{< link-hextra path="/documentation/traffic-management/buffering/" >}}), which configures the gateway-level `frontend.http.maxBufferSize` limit used by policies that need buffering.
