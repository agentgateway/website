...
quickstart]({{< link-hextra path="/documentation/inference/#setup" >}}). In the
...
Complete the [inference routing quickstart]({{< link-hextra path="/documentation/inference/#setup" >}}). The quickstart creates:
...
> InferencePools]({{< link-hextra path="/documentation/inference/#ai-policies" >}}).
