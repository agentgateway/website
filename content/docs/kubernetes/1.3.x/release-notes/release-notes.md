...
- `agctl proxy log` gets or sets the proxy log level at runtime. For more information, see [Debug your setup]({{< link-hextra path="/documentation/operations/debug/#debug-logs" >}}).
- `agctl controller log` gets or sets the agentgateway controller log level per component at runtime. For more information, see [Debug your setup]({{< link-hextra path="/documentation/operations/debug/#debug-logs" >}}).
- `agctl version` prints version information for the `agctl` CLI.

For more information, see [Install `agctl`]({{< link-hextra path="/documentation/operations/agctl/" >}}), [Inspect agentgateway configuration]({{< link-hextra path="/documentation/operations/inspect-config/" >}}), [Trace requests with `agctl`]({{< link-hextra path="/documentation/operations/trace-requests/" >}}), and the [`agctl` CLI reference]({{< link-hextra path="/reference/agctl/" >}}).
