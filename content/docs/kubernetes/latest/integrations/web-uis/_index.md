...
{{< callout type="info" >}}
Looking for a UI to review your agentgateway resources such as routes and policies? Check out the [agentgateway Admin UI]({{< link-hextra path="/observability/ui/" >}}) guide.
