...
{{< cards >}}
  ...
  {{< card link="prometheus" title="Prometheus" subtitle="Metrics collection and alerting" >}}
  {{< card link="grafana" title="Grafana" subtitle="Dashboards and visualization" >}}
  {{< card link="jaeger" title="Jaeger" subtitle="Distributed tracing backend" >}}
{{< /cards >}}
