...
Add agentgateway to your Antigravity IDE MCP configuration. Set the `serverUrl` to your agentgateway proxy address, which defaults to `http://localhost:3000/mcp` for local deployments:
