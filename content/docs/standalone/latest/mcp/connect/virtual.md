...
1. Download a multiplex configuration for your agentgateway.
   ...
   ```yaml
   curl -L https://raw.githubusercontent.com/agentgateway/agentgateway/main/examples/multiplex/config.yaml -o config.yaml
   ```
...
2. Review the configuration file. 
   ...
   {{% github-yaml url="https://raw.githubusercontent.com/agentgateway/agentgateway/main/examples/multiplex/config.yaml" %}}
