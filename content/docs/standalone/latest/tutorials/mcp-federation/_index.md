...
{{< cards >}}
  ...
  {{< card link="/tutorials/mcp-authentication" title="MCP Auth" subtitle="OAuth-based authentication" >}}
  {{< card link="/mcp/" title="MCP Overview" subtitle="Understanding MCP connectivity" >}}
{{< /cards >}}
