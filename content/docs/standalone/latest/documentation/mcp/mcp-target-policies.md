...
[Set up MCP multiplexed backends]({{< link-hextra path="/documentation/mcp/connect/virtual" >}}).
...
- [Backend Authentication]({{< link-hextra path="/documentation/configuration/security/backend-authn" >}})
