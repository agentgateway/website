...
test:
  realtime-standalone:
  - file: ${versionRoot}/documentation/llm/api-types/realtime.md
...
[Install the `agentgateway` binary]({{< link-hextra path="/documentation/setup/install/binary/">}}).
...
For more information about LLM metrics and observability, see [Observe traffic]({{< link-hextra path="/documentation/llm/observability/" >}}).