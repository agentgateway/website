...
For setup instructions, see [Use Claude models on Azure AI Foundry]({{< link-hextra path="/documentation/llm/providers/azure/#use-claude-models-on-azure-ai-foundry" >}}).
