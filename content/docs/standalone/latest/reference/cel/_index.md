...
This section covers everything you need to write and debug CEL expressions in agentgateway: the in-product playground, how to embed expressions in YAML, common example patterns, reusable custom functions, and the variables that are exposed at each policy phase.
