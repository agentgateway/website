...
- A consistent place to apply [rate limits]({{< link-hextra path="/documentation/llm/cost-controls/virtual-keys/" >}}) and capture [observability data]({{< link-hextra path="/documentation/llm/observability/" >}}).
