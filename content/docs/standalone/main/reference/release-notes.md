...
<!-- TODO 1.6 relnotes: the v1.5 sections below are the copy that the version
     ...
     1.5 lives in content/docs/standalone/latest/reference/release-notes.md.
     ...
     Session affinity is deliberately absent above: standalone shipped it in
     1.5, so it stays in the v1.5 notes. Only the Kubernetes API surface is new
     in 1.6. -->
