...
Use this page for providers that implement the OpenAI API format but do not have a first-class `provider:` support yet. For built-in providers such as [Baseten]({{< link-hextra path="/documentation/llm/providers/baseten/" >}}), [Cerebras]({{< link-hextra path="/documentation/llm/providers/cerebras/" >}}), [Cohere]({{< link-hextra path="/documentation/llm/providers/cohere/" >}}), [DeepInfra]({{< link-hextra path="/documentation/llm/providers/deepinfra/" >}}), [DeepSeek]({{< link-hextra path="/documentation/llm/providers/deepseek/" >}}), [Fireworks AI]({{< link-hextra path="/documentation/llm/providers/fireworks/" >}}), [Groq]({{< link-hextra path="/documentation/llm/providers/groq/" >}}), [Hugging Face]({{< link-hextra path="/documentation/llm/providers/huggingface/" >}}), [Mistral]({{< link-hextra path="/documentation/llm/providers/mistral/" >}}), [OpenRouter]({{< link-hextra path="/documentation/llm/providers/openrouter/" >}}), [Together AI]({{< link-hextra path="/documentation/llm/providers/togetherai/" >}}), [xAI]({{< link-hextra path="/documentation/llm/providers/xai/" >}}), and [Ollama]({{< link-hextra path="/documentation/llm/providers/ollama/" >}}), use the dedicated provider pages instead.
