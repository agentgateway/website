...
Additionally, each modification is based on a [CEL expression]({{< link-hextra path="/documentation/configuration/traffic-management/transformations" >}}) rather than static strings.