...
The injected delay counts against the request timeout. If the delay is longer than the configured [request timeout]({{< link-hextra path="/documentation/configuration/resiliency/timeouts/" >}}), the request times out.
